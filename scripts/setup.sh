...
if [ "$(uname)" == "Darwin" ]; then
    ...
    wget -c https://github.com/starkware-libs/cairo/releases/download/v2.9.3/release-aarch64-apple-darwin.tar -O - | tar -xz
    ...
    wget -c https://github.com/starkware-libs/cairo/releases/download/v2.9.3/release-x86_64-unknown-linux-musl.tar.gz -O - | tar -xz
